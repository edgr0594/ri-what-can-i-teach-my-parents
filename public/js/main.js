...
var prLover = {
  ...
  templateNote: function(noteData) {
      ...
      newNote = newNote + "<div class='note-footer'><div class='note-vote'><button type='button' data-noteid='" + noteData._id + "'  class='btn-default'><i class='fa fa-heart loved'></i><span class='vote-count'> " + voteCount + "</span> </button></div></div>";
    newNote = newNote + "</li>";
